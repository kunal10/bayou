...
public class Master {
	...
	public static void main(String[] args) {
		...
		while (scan.hasNextLine()) {
			...
			case "stabilize":
				/*
				 * Block until there are enough Anti-Entropy messages for all
				 * values to propagate through the currently connected servers.
				 * In general, the time that this function blocks for should
				 * increase linearly with the number of servers in the system.
				 */
				break;
			case "printLog":
				serverId = Integer.parseInt(inputLine[1]);
